...
graph TD
    ...
    subgraph K3s[K3s Cluster - Xeon Master - 100.77.46.69]
        ...
        subgraph Apps[Namespace: default]
            SC[social-care v0.8.0]
            SC_HML[social-care-hml v0.8.0]
...
|---------|---------|--------|-----------|
| social-care | `social-care.acdgbrasil.com.br` | v0.8.0 | API de assistencia social (prod) |
| social-care-hml | `social-care-hml.acdgbrasil.com.br` | v0.8.0 | Ambiente de homologacao |
